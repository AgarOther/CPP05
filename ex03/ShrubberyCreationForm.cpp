...
/*   Updated: 2025/05/06 23:48:16 by scraeyme         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	return ("Critical: Couldn't create output file for Shrubbery.");
}
...
void ShrubberyCreationForm::execute(const Bureaucrat &executor) const
{
	...
	if (executor.getGrade() <= getExecGrade())
	{
		...
		{
			std::cout << _target << "_shrubbery already exists!" << std::endl;
			file.close();
		}
	}
	else
